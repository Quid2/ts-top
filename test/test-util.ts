...
import { parseShake48, parseAbsRef } from "../index"
...
console.log(new TypeApp(new TypeCon(new String("Maybe")), new TypeCon(new String("a"))).map((name) => new String("PRE: " + name.value)).pretty())
