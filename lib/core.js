...
var DecoderState = /** @class */ (function () {
    ...
    // should return unit
    DecoderState.prototype.dFiller = function () {
        var b = this.dBit();
        if (b == null) {
            return null;
        }
    ...
    DecoderState.prototype.dBit = function () {
        if (!this.hasBit())
            return null;
    ...
    DecoderState.prototype.dBits8 = function (numBits) {
    ...
    DecoderState.prototype.isEnd = function () {
        return this.availableBits() == 0;
    };
    // Is this required? Or we can rely on build in js checks?
    DecoderState.prototype.hasBit = function () {
        return this.currPtr < this.buffer.byteLength;
    };
    DecoderState.prototype.hasBits = function (requiredBits) {
        return requiredBits > this.availableBits();
    };
    /** Decode a Filler, a special value that is used to byte align values.
      */
    DecoderState.prototype.zmFiller = function (decoders) {
        while (this.zero())
            ;
        return "";
    };
    DecoderState.prototype.zmBytes = function (decoders) { this.zmFiller(); return this.byteArray(); };
    DecoderState.prototype.zmChar = function (decoders) { return String.fromCharCode(this.word()); };
    DecoderState.prototype.zmString = function (decoders) {
        var s = "";
        while (!this.zero()) {
            s += this.zmChar();
        }
...
var EncoderState = /** @class */ (function () {
    ...
    EncoderState.prototype.zmBytes = function (v) { this.zmFiller(); this.byteArray(v); };
    EncoderState.prototype.zmChar = function (v) { this.word(v.charCodeAt(0)); };
    EncoderState.prototype.zmString = function (s) {
        var l = s.length;
        for (var i = 0; i < l; i++) {
            this.one();
    ...
    EncoderState.prototype.zmFiller = function (v) {
        this.currentByte |= 1;
        this.nextWord();
    };
    ...
    EncoderState.szFiller = function (v) { return 8; };
    ...
    EncoderState.szString = function (v) { return v.length * 25 + 1; };
