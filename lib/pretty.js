...
K86653e040025_1.Con.prototype.pretty = function () {
    return this.constrName.pretty() + " " + this.constrFields.match({ Left: function (ts) { return Kb8cd13187198_1.prettyConcat(ts); }, Right: function (ts) { return "{" + Kb8cd13187198_1.prettyConcat(ts, ",") + "}"; } });
};
