...
exports.DecoderState = exports.EncoderState = exports.unflat = exports.zmType = exports.flat = void 0;
...
function flat(v) {
    ...
    let st = new ts_core_1.EncoderState(numBytes);
    val.flatEncode(st);
    return st.seal();
}
exports.flat = flat;
...
function unflat(dec, buf) {
    ...
    const st = new ts_core_1.DecoderState(buf);
    const v = dec(st);
    st.zmFiller();
    st.seal();
    return v;
