...
exports.CallChannel = exports.channel = exports.Channel = exports.typedBLOB = exports.flatBLOB = void 0;
...
class Channel {
    constructor(t, client) {
        ...
        const dec = t(ts_core_1.flatDecoder);
        var firstTime = true;
        ...
        skt.onmessage = function (event) {
            ...
            if (firstTime) {
                ...
                firstTime = false;
                const ansDecoder = Kc6627a317dbc_1.$ChannelSelectionResult(Kc802c6aae1af_1.$WebSocketAddress(K6cb2ee3ac409_1.$IP4Address))(ts_core_1.flatDecoder);
                const answer = api_1.unflat(ansDecoder, new Uint8Array(event.data));
                answer.match({
                    Success: client.onOpen(function (v) {
                        skt.send(api_1.flat(v));
                    }, function () {
                        skt.close();
                    }),
