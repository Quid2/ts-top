...
var WebSocketAddress = /** @class */ (function () {
    ...
    WebSocketAddress.prototype.toString = function () {
    ...
    WebSocketAddress.prototype.pretty = function (nested) {
        if (nested === void 0) { nested = false; }
        return Q.nestedPars(nested, [
            "WebSocketAddress",
    ...
    WebSocketAddress.prototype.match = function (m) {
        return m.WebSocketAddress(this.secure, this.host, this.path);
    };
    WebSocketAddress.prototype.flatMaxSize = function () {
        return (this.secure.flatMaxSize() +
            this.host.flatMaxSize() +
            this.path.flatMaxSize());
    };
    WebSocketAddress.prototype.flatEncode = function (st) {
