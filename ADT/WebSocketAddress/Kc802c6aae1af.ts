...
export const $WebSocketAddress:<A extends Q.ZM>(t0:Q.zmFold<A>) => Q.zmFold<WebSocketAddress<A>> = function (t1) {return function (f) {return f(___,[t1(f)])}}
...
export class WebSocketAddress <A extends Q.ZM> implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["WebSocketAddress",this.secure.pretty(true),this.host.pretty(true),this.path.pretty(true)].join(' '))}
