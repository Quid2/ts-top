...
export const $WebSocketAddress: <A extends Q.ZM>(
  t0: Q.zmFold<A>
) => Q.zmFold<WebSocketAddress<A>> = function (t1) {
  return function (f) {
    return f(___, [t1(f)]);
  };
};
  ...
  decoder: function (decoders) {
    return function (st) {
      return new WebSocketAddress(
        K306f1981b41c.___.decoder([])(st),
        Ke5d02571ce7b.___.decoder([decoders[0]])(st),
