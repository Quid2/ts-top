...
exports.Bits11 = exports.___ = exports.$Bits11 = void 0;
...
class Bits11 {
    ...
    pretty(nested = false) { return Q.nestedPars(nested, ["Bits11", this.bit0.pretty(true), this.bit1.pretty(true), this.bit2.pretty(true), this.bit3.pretty(true), this.bit4.pretty(true), this.bit5.pretty(true), this.bit6.pretty(true), this.bit7.pretty(true), this.bit8.pretty(true), this.bit9.pretty(true), this.bit10.pretty(true)].join(' ')); }
