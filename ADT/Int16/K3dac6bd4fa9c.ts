...
export const $Int16: Q.zmFold<Int16> = function (f) {
  return f(___, []);
};
...
export const ___: Q.zmTypeInfo = {
  ...
  decoder: function (decoders) {
    return function (st) {
      return new Int16(
        K03226796ede4.___.decoder([K295e24d62fac.___.decoder([])])(st)
      );
    };
  },
};
...
export class Int16 implements Q.ZM {
  constructor(public readonly _0: K03226796ede4.ZigZag<K295e24d62fac.Word16>) {}
