...
exports.Just = exports.Nothing = exports.___ = exports.$Maybe = void 0;
var Q = require("@quid2/ts-core");
exports.$Maybe = function (t1) {
    return function (f) {
...
var Nothing = /** @class */ (function () {
    ...
    Nothing.prototype.flatMaxSize = function () {
        return 1 + 0;
    };
    Nothing.prototype.flatEncode = function (st) {
        st.zero();
    };
    return Nothing;
}());
...
var Just = /** @class */ (function () {
    ...
    Just.prototype.flatMaxSize = function () {
        return 1 + this._0.flatMaxSize();
    };
    Just.prototype.flatEncode = function (st) {
        st.one();
