...
export const $ByPattern:<A extends Q.ZM>(t0:Q.zmFold<A>) => Q.zmFold<ByPattern<A>> = function (t1) {return function (f) {return f(___,[t1(f)])}}
...
export class ByPattern <A extends Q.ZM> implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["ByPattern",this._0.pretty(true)].join(' '))}
