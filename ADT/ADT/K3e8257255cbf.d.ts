...
export declare const $ADT: <A extends Q.ZM, B extends Q.ZM, C extends Q.ZM>(t0: Q.zmFold<A>, t1: Q.zmFold<B>, t2: Q.zmFold<C>) => Q.zmFold<ADT<A, B, C>>;
export declare const ___: Q.zmTypeInfo;
export declare class ADT<A extends Q.ZM, B extends Q.ZM, C extends Q.ZM> implements Q.ZM {
    declName: A;
