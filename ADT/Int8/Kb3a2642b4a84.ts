...
export const $Int8: Q.zmFold<Int8> = function (f) {
  return f(___, []);
};
...
export const ___: Q.zmTypeInfo = {
  ...
  decoder: function (decoders) {
    return function (st) {
      return new Int8(
        K03226796ede4.___.decoder([Kb1f46a49c8f8.___.decoder([])])(st)
      );
    };
  },
};
...
export class Int8 implements Q.ZM {
  constructor(public readonly _0: K03226796ede4.ZigZag<Kb1f46a49c8f8.Word8>) {}

  toString(): string {
    return this.toStr(false);
  }
  toStr(nested = false): string {
    return Q.nestedPars(nested, ["Int8", this._0.toStr(true)].join(" "));
  }
  pretty(nested = false): string {
    return Q.nestedPars(nested, ["Int8", this._0.pretty(true)].join(" "));
  }

  match<R>(m: {
    Int8: (v0: K03226796ede4.ZigZag<Kb1f46a49c8f8.Word8>) => R;
  }): R {
    return m.Int8(this._0);
  }
  flatMaxSize(): number {
