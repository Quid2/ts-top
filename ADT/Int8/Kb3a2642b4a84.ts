...
export class Int8  implements Q.ZM {
  ...
  toStr(nested=false):string {return Q.nestedPars(nested,["Int8",this._0.toStr(true)].join(' '))}
  pretty(nested=false):string {return Q.nestedPars(nested,["Int8",this._0.pretty(true)].join(' '))}
