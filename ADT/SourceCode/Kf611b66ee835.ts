...
export const $SourceCode:<A extends Q.ZM>(t0:Q.zmFold<A>) => Q.zmFold<SourceCode<A>> = function (t1) {return function (f) {return f(___,[t1(f)])}}
...
export class SourceCode <A extends Q.ZM> implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["SourceCode",this._0.pretty(true),this._1.pretty(true)].join(' '))}

  match <R>(m:{SourceCode:(v0:A,v1:Kb8cd13187198.List<K066db52af145.Char>)=>R}) : R {return m.SourceCode(this._0,this._1);}
