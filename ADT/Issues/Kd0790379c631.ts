...
export const $Issues:<A extends Q.Flat,B extends Q.Flat>(t0:Q.zmFold<A>,t1:Q.zmFold<B>) => Q.zmFold<Issues<A,B>> = function (t1,t2) {return function (f) {return f(___,[t1(f),t2(f)])}}
...
export class Issues <A extends Q.Flat,B extends Q.Flat> implements Q.Flat {
  constructor(
