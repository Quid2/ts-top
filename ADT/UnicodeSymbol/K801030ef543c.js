...
exports.UnicodeSymbol = exports.___ = exports.$UnicodeSymbol = void 0;
var Q = require("@quid2/ts-core");
var K066db52af145 = require("../Char/K066db52af145");
exports.$UnicodeSymbol = function (f) {
...
var UnicodeSymbol = /** @class */ (function () {
    ...
    UnicodeSymbol.prototype.toString = function () {
    ...
    UnicodeSymbol.prototype.match = function (m) {
        return m.UnicodeSymbol(this._0);
    };
    UnicodeSymbol.prototype.flatMaxSize = function () {
        return this._0.flatMaxSize();
    };
    UnicodeSymbol.prototype.flatEncode = function (st) {
