...
export class Bits23  implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["Bits23",this.bit0.pretty(true),this.bit1.pretty(true),this.bit2.pretty(true),this.bit3.pretty(true),this.bit4.pretty(true),this.bit5.pretty(true),this.bit6.pretty(true),this.bit7.pretty(true),this.bit8.pretty(true),this.bit9.pretty(true),this.bit10.pretty(true),this.bit11.pretty(true),this.bit12.pretty(true),this.bit13.pretty(true),this.bit14.pretty(true),this.bit15.pretty(true),this.bit16.pretty(true),this.bit17.pretty(true),this.bit18.pretty(true),this.bit19.pretty(true),this.bit20.pretty(true),this.bit21.pretty(true),this.bit22.pretty(true)].join(' '))}
