...
export const $PreAligned:<A extends Q.ZM>(t0:Q.zmFold<A>) => Q.zmFold<PreAligned<A>> = function (t1) {return function (f) {return f(___,[t1(f)])}}
...
export class PreAligned <A extends Q.ZM> implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["PreAligned",this.preFiller.pretty(true),this.preValue.pretty(true)].join(' '))}
