...
var Word32 = /** @class */ (function () {
    ...
    Word32.prototype.flatMaxSize = function () { return Q.EncoderState.szWord32(this.value); };
    Word32.prototype.flatEncode = function (st) { st.zmWord32(this.value); };
    Word32.prototype.toString = function () { return this.toStr(false); };
    Word32.prototype.toStr = function (nested) { return this.value.toString(); };
    Word32.prototype.pretty = function (nested) { return this.toString(); };
    return Word32;
}());
