...
exports._ConTree = exports.Con = exports.___ = exports.$ConTree = void 0;
...
exports.$ConTree = function (t1, t2) {
    return function (f) {
...
exports.___ = {
    ...
    decoder: function (decoders) {
        return function (st) {
            if (st.zero()) {
                return new Con(decoders[0](st), K6260e465ae74.___.decoder([
...
exports.Con = Con;
var _ConTree = /** @class */ (function () {
    function _ConTree(_0, _1) {
        this._0 = _0;
        this._1 = _1;
    }
    _ConTree.prototype.toString = function () {
        return this.toStr(false);
    };
    ...
    _ConTree.prototype.match = function (m) {
        return m.ConTree(this._0, this._1);
    };
    _ConTree.prototype.flatMaxSize = function () {
        return 1 + this._0.flatMaxSize() + this._1.flatMaxSize();
    };
    _ConTree.prototype.flatEncode = function (st) {
        st.one();
