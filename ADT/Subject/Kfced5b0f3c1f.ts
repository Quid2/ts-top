...
export class Subject  implements Q.ZM {
  constructor(
    public readonly _0: Kb8cd13187198.List<Kb8cd13187198.List<K066db52af145.Char>>,

  ) { }

  toString():string {return this.toStr(false)}
  toStr(nested=false):string {return Q.nestedPars(nested,["Subject",this._0.toStr(true)].join(' '))}
  pretty(nested=false):string {return Q.nestedPars(nested,["Subject",this._0.pretty(true)].join(' '))}
