...
exports.Ext = exports.Rec = exports.Var = exports.___ = exports.$ADTRef = void 0;
var Q = require("@quid2/ts-core");
var Kb1f46a49c8f8 = require("../Word8/Kb1f46a49c8f8");
exports.$ADTRef = function (t1) {
    return function (f) {
...
var Var = /** @class */ (function () {
    ...
    Var.prototype.match = function (m) {
        return m.Var(this._0);
    };
    Var.prototype.flatMaxSize = function () {
        return 1 + this._0.flatMaxSize();
    };
    Var.prototype.flatEncode = function (st) {
        st.zero();
...
var Rec = /** @class */ (function () {
    ...
    Rec.prototype.match = function (m) {
        return m.Rec;
    };
    Rec.prototype.flatMaxSize = function () {
        return 2 + 0;
    };
    Rec.prototype.flatEncode = function (st) {
        st.one();
        st.zero();
    };
    return Rec;
...
var Ext = /** @class */ (function () {
    ...
    Ext.prototype.toString = function () {
        return this.toStr(false);
    };
    ...
    Ext.prototype.match = function (m) {
        return m.Ext(this._0);
    };
    Ext.prototype.flatMaxSize = function () {
        return 2 + this._0.flatMaxSize();
    };
    Ext.prototype.flatEncode = function (st) {
        st.one();
        st.one();
        this._0.flatEncode(st);
    };
