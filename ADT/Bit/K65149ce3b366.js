...
exports.V1 = exports.V0 = exports.___ = exports.$Bit = void 0;
exports.$Bit = function (f) {
...
var V0 = /** @class */ (function () {
    ...
    V0.prototype.match = function (m) {
        return m.V0;
    };
    V0.prototype.flatMaxSize = function () {
        return 1 + 0;
    };
    V0.prototype.flatEncode = function (st) {
        st.zero();
    };
    return V0;
}());
...
var V1 = /** @class */ (function () {
    ...
    V1.prototype.match = function (m) {
        return m.V1;
    };
    V1.prototype.flatMaxSize = function () {
        return 1 + 0;
    };
    V1.prototype.flatEncode = function (st) {
        st.one();
    };
    return V1;
}());
