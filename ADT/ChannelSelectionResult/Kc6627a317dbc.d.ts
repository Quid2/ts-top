...
export declare const $ChannelSelectionResult: <A extends Q.ZM>(t0: Q.zmFold<A>) => Q.zmFold<ChannelSelectionResult<A>>;
export declare const ___: Q.zmTypeInfo;
export declare type ChannelSelectionResult<A extends Q.ZM> = Success<A> | Failure<A> | RetryAt<A>;
