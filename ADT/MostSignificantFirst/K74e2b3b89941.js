...
var MostSignificantFirst = /** @class */ (function () {
    ...
    MostSignificantFirst.prototype.toString = function () {
    ...
    MostSignificantFirst.prototype.match = function (m) {
        return m.MostSignificantFirst(this._0);
    };
    MostSignificantFirst.prototype.flatMaxSize = function () {
        return this._0.flatMaxSize();
    };
    MostSignificantFirst.prototype.flatEncode = function (st) {
