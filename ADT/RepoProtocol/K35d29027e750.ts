...
export const $RepoProtocol: Q.zmFold<RepoProtocol> = function (f) {
  return f(___, []);
};
  ...
  decoder: function (decoders) {
    return function (st) {
      if (st.zero()) {
        if (st.zero()) {
          return new Record(
            K3e8257255cbf.___.decoder([
              Kdc26e9d90047.___.decoder([]),
              Kdc26e9d90047.___.decoder([]),
              K07b1b045ac3c.___.decoder([K4bbd38587b9e.___.decoder([])]),
            ])(st)
          );
        } else {
          if (st.zero()) {
        ...
        if (st.zero()) {
          ...
          if (st.zero()) {
            ...
            return new KnownDataTypesRefs(
              Kb8cd13187198.___.decoder([
                Ka5583bf3ad34.___.decoder([
                  K4bbd38587b9e.___.decoder([]),
                  K2f006595638c.___.decoder([]),
                ]),
              ])(st)
            );
          }
...
export class Record implements Q.ZM {
  constructor(
    public readonly _0: K3e8257255cbf.ADT<
      Kdc26e9d90047.Identifier,
      Kdc26e9d90047.Identifier,
      K07b1b045ac3c.ADTRef<K4bbd38587b9e.AbsRef>
    >
  ) {}
  ...
  pretty(nested = false): string {
    return Q.nestedPars(nested, ["Record", this._0.pretty(true)].join(" "));
  }

  match<R>(m: {
    Record: (
      v0: K3e8257255cbf.ADT<
        Kdc26e9d90047.Identifier,
        Kdc26e9d90047.Identifier,
        K07b1b045ac3c.ADTRef<K4bbd38587b9e.AbsRef>
      >
    ...
    Solved: (
      v0: K4bbd38587b9e.AbsRef,
      v1: K3e8257255cbf.ADT<
        Kdc26e9d90047.Identifier,
        Kdc26e9d90047.Identifier,
        K07b1b045ac3c.ADTRef<K4bbd38587b9e.AbsRef>
      >
    ...
    KnownDataTypes: (
      v0: Kb8cd13187198.List<
        Ka5583bf3ad34.Tuple2<
          K4bbd38587b9e.AbsRef,
          K3e8257255cbf.ADT<
            Kdc26e9d90047.Identifier,
            Kdc26e9d90047.Identifier,
            K07b1b045ac3c.ADTRef<K4bbd38587b9e.AbsRef>
    ...
    KnownDataTypesRefs: (
      v0: Kb8cd13187198.List<
        Ka5583bf3ad34.Tuple2<K4bbd38587b9e.AbsRef, K2f006595638c.String>
      >
    ) => R;
  }): R {
    return m.Record(this._0);
  }
  flatMaxSize(): number {
...
export class Solve implements Q.ZM {
  constructor(public readonly _0: K4bbd38587b9e.AbsRef) {}
...
export class Solved implements Q.ZM {
  constructor(
    ...
    public readonly _1: K3e8257255cbf.ADT<
      Kdc26e9d90047.Identifier,
      Kdc26e9d90047.Identifier,
      K07b1b045ac3c.ADTRef<K4bbd38587b9e.AbsRef>
    >
  ...
  toStr(nested = false): string {
    return Q.nestedPars(
      nested,
      ["Solved", this._0.toStr(true), this._1.toStr(true)].join(" ")
    );
  }
  pretty(nested = false): string {
    return Q.nestedPars(
      nested,
      ["Solved", this._0.pretty(true), this._1.pretty(true)].join(" ")
    );
  }
  ...
  match<R>(m: {
    ...
    return m.Solved(this._0, this._1);
  }
  flatMaxSize(): number {
    return 3 + this._0.flatMaxSize() + this._1.flatMaxSize();
  }
  flatEncode(st: Q.EncoderState) {
    st.zero();
    st.one();
...
export class KnownDataTypes implements Q.ZM {
  ...
  toStr(nested = false): string {
    return Q.nestedPars(
      nested,
      ["KnownDataTypes", this._0.toStr(true)].join(" ")
    );
  }
  pretty(nested = false): string {
    return Q.nestedPars(
      nested,
      ["KnownDataTypes", this._0.pretty(true)].join(" ")
    );
  }
  ...
  match<R>(m: {
    ...
    return m.KnownDataTypes(this._0);
  }
  flatMaxSize(): number {
    return 3 + this._0.flatMaxSize();
  }
...
export class KnownDataTypesRefs implements Q.ZM {
  ...
  toStr(nested = false): string {
    return Q.nestedPars(
      nested,
      ["KnownDataTypesRefs", this._0.toStr(true)].join(" ")
    );
  }
  pretty(nested = false): string {
    return Q.nestedPars(
      nested,
      ["KnownDataTypesRefs", this._0.pretty(true)].join(" ")
    );
  }
  ...
  match<R>(m: {
    ...
    return m.KnownDataTypesRefs(this._0);
  }
  flatMaxSize(): number {
    return 3 + this._0.flatMaxSize();
  }
