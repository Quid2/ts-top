...
export class AskDataTypesRefs  implements Q.Flat {
...
export class KnownDataTypesRefs  implements Q.Flat {
  constructor(
    public _0: Kb8cd13187198.List<Ka5583bf3ad34.Tuple2<K4bbd38587b9e.AbsRef,K2f006595638c.String>>,
