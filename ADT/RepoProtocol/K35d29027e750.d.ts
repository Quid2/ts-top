...
export declare type RepoProtocol =
  | Record
  | Solve
  | Solved
  | AskDataTypes
...
export declare class AskDataTypesRefs implements Q.ZM {
  toString(): string;
  toStr(nested?: boolean): string;
  pretty(nested?: boolean): string;
  match<R>(m: {
...
export declare class KnownDataTypesRefs implements Q.ZM {
  readonly _0: Kb8cd13187198.List<
    Ka5583bf3ad34.Tuple2<K4bbd38587b9e.AbsRef, K2f006595638c.String>
  >;
  constructor(
