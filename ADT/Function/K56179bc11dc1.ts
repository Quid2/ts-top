...
export const $Function: <A extends Q.ZM, B extends Q.ZM, C extends Q.ZM>(
  t0: Q.zmFold<A>,
  t1: Q.zmFold<B>,
  t2: Q.zmFold<C>
) => Q.zmFold<Function<A, B, C>> = function (t1, t2, t3) {
  return function (f) {
...
export type Function<A extends Q.ZM, B extends Q.ZM, C extends Q.ZM> =
  | Call<A, B, C>
  | Reply<A, B, C>;

export class Call<A extends Q.ZM, B extends Q.ZM, C extends Q.ZM>
  implements Q.ZM {
  ...
  match<R>(m: { Call: (v0: A) => R; Reply: (v0: B, v1: C) => R }): R {
...
export class Reply<A extends Q.ZM, B extends Q.ZM, C extends Q.ZM>
  implements Q.ZM {
  constructor(public readonly _0: B, public readonly _1: C) {}
