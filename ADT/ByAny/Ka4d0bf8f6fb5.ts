...
export const $ByAny:<A extends Q.ZM>(t0:Q.zmFold<A>) => Q.zmFold<ByAny<A>> = function (t1) {return function (f) {return f(___,[t1(f)])}}
...
export class ByAny <A extends Q.ZM> implements Q.ZM {
  ...
  pretty(nested=false):string {return "ByAny"}
