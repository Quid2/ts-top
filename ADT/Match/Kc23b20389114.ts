...
export const $Match:<A extends Q.ZM>(t0:Q.zmFold<A>) => Q.zmFold<Match<A>> = function (t1) {return function (f) {return f(___,[t1(f)])}}
...
export class MatchValue <A extends Q.ZM> implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["MatchValue",this._0.pretty(true)].join(' '))}
...
export class MatchAny <A extends Q.ZM> implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["MatchAny",this._0.pretty(true)].join(' '))}
