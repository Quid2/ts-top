...
exports.IEEE_754_binary64 = exports.___ = exports.$IEEE_754_binary64 = void 0;
...
class IEEE_754_binary64 {
    ...
    pretty(nested = false) { return Q.nestedPars(nested, ["IEEE_754_binary64", this.sign.pretty(true), this.exponent.pretty(true), this.fraction.pretty(true)].join(' ')); }
