...
export class IEEE_754_binary64  implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["IEEE_754_binary64",this.sign.pretty(true),this.exponent.pretty(true),this.fraction.pretty(true)].join(' '))}
