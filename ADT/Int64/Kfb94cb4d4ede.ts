...
export const $Int64: Q.zmFold<Int64> = function (f) {
  return f(___, []);
};
...
export const ___: Q.zmTypeInfo = {
  ...
  decoder: function (decoders) {
    return function (st) {
      return new Int64(
        K03226796ede4.___.decoder([K50d018f7593a.___.decoder([])])(st)
      );
    };
  },
};
...
export class Int64 implements Q.ZM {
  constructor(public readonly _0: K03226796ede4.ZigZag<K50d018f7593a.Word64>) {}
  ...
  pretty(nested = false): string {
    return Q.nestedPars(nested, ["Int64", this._0.pretty(true)].join(" "));
  }

  match<R>(m: {
    Int64: (v0: K03226796ede4.ZigZag<K50d018f7593a.Word64>) => R;
  }): R {
    return m.Int64(this._0);
  }
  flatMaxSize(): number {
