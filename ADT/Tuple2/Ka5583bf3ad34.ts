...
export const $Tuple2:<A extends Q.ZM,B extends Q.ZM>(t0:Q.zmFold<A>,t1:Q.zmFold<B>) => Q.zmFold<Tuple2<A,B>> = function (t1,t2) {return function (f) {return f(___,[t1(f),t2(f)])}}
...
export class Tuple2 <A extends Q.ZM,B extends Q.ZM> implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["Tuple2",this._0.pretty(true),this._1.pretty(true)].join(' '))}
