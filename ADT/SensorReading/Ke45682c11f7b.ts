...
export const $SensorReading:<A extends Q.ZM,B extends Q.ZM>(t0:Q.zmFold<A>,t1:Q.zmFold<B>) => Q.zmFold<SensorReading<A,B>> = function (t1,t2) {return function (f) {return f(___,[t1(f),t2(f)])}}
...
export class SensorReading <A extends Q.ZM,B extends Q.ZM> implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["SensorReading",this.reading.pretty(true),this.location.pretty(true)].join(' '))}
