...
export const $SHA3_256_6:<A extends Q.ZM>(t0:Q.zmFold<A>) => Q.zmFold<SHA3_256_6<A>> = function (t1) {return function (f) {return f(___,[t1(f)])}}
...
export class SHA3_256_6 <A extends Q.ZM> implements Q.ZM {
  ...
  toStr(nested=false):string {return Q.nestedPars(nested,["SHA3_256_6",this._0.toStr(true),this._1.toStr(true),this._2.toStr(true),this._3.toStr(true),this._4.toStr(true),this._5.toStr(true)].join(' '))}
  pretty(nested=false):string {return Q.nestedPars(nested,["SHA3_256_6",this._0.pretty(true),this._1.pretty(true),this._2.pretty(true),this._3.pretty(true),this._4.pretty(true),this._5.pretty(true)].join(' '))}
