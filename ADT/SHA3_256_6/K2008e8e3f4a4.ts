...
export const $SHA3_256_6: <A extends Q.ZM>(
  t0: Q.zmFold<A>
) => Q.zmFold<SHA3_256_6<A>> = function (t1) {
  return function (f) {
    return f(___, [t1(f)]);
  };
};
...
export class SHA3_256_6<A extends Q.ZM> implements Q.ZM {
  ...
  match<R>(m: {
    ...
    return m.SHA3_256_6(this._0, this._1, this._2, this._3, this._4, this._5);
  }
  flatMaxSize(): number {
    return (
      this._0.flatMaxSize() +
