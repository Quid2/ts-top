...
var SHA3_256_6 = (function () {
    ...
    SHA3_256_6.prototype.toStr = function (nested) {
        ...
        return Q.nestedPars(nested, "SHA3_256_6" + this._0.toStr(true) + this._1.toStr(true) + this._2.toStr(true) + this._3.toStr(true) + this._4.toStr(true) + this._5.toStr(true));
    };
