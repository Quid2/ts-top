...
export declare const $Content: <A extends Q.ZM, B extends Q.ZM>(
  t0: Q.zmFold<A>,
  t1: Q.zmFold<B>
) => Q.zmFold<Content<A, B>>;
export declare const ___: Q.zmTypeInfo;
export declare type Content<A extends Q.ZM, B extends Q.ZM> =
  | TextMessage<A, B>
  | AskSubSubjects<A, B>
  | Join<A, B>
  | Leave<A, B>
  ...
  | AskHistory<A, B>
  | History<A, B>;
export declare class TextMessage<A extends Q.ZM, B extends Q.ZM>
  implements Q.ZM {
...
export declare class AskSubSubjects<A extends Q.ZM, B extends Q.ZM>
  implements Q.ZM {
  toString(): string;
  toStr(nested?: boolean): string;
  pretty(nested?: boolean): string;
...
export declare class AskHistory<A extends Q.ZM, B extends Q.ZM>
  implements Q.ZM {
  toString(): string;
  toStr(nested?: boolean): string;
  pretty(nested?: boolean): string;
