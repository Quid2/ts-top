...
export const $AbsRef: Q.zmFold<AbsRef> = function (f) {
  return f(___, []);
};
...
export const ___: Q.zmTypeInfo = {
  ...
  decoder: function (decoders) {
    return function (st) {
      return new AbsRef(
        K9f214799149b.___.decoder([
          K3e8257255cbf.___.decoder([
            Kdc26e9d90047.___.decoder([]),
            Kdc26e9d90047.___.decoder([]),
            K07b1b045ac3c.___.decoder([___.decoder([])]),
          ]),
        ])(st)
      );
    };
...
export class AbsRef implements Q.ZM {
  constructor(
    public readonly _0: K9f214799149b.SHAKE128_48<
      K3e8257255cbf.ADT<
        Kdc26e9d90047.Identifier,
        Kdc26e9d90047.Identifier,
        K07b1b045ac3c.ADTRef<AbsRef>
      >
    >
  ) {}
