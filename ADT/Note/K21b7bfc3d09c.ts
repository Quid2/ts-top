...
export const $Note:<A extends Q.ZM,B extends Q.ZM>(t0:Q.zmFold<A>,t1:Q.zmFold<B>) => Q.zmFold<Note<A,B>> = function (t1,t2) {return function (f) {return f(___,[t1(f),t2(f)])}}
...
export class Note <A extends Q.ZM,B extends Q.ZM> implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["Note",this.annotation.pretty(true),this.object.pretty(true)].join(' '))}
