...
exports.Note = exports.___ = exports.$Note = void 0;
...
class Note {
    ...
    pretty(nested = false) { return Q.nestedPars(nested, ["Note", this.annotation.pretty(true), this.object.pretty(true)].join(' ')); }
