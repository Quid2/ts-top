...
export const $NonEmptyList:<A extends Q.ZM>(t0:Q.zmFold<A>) => Q.zmFold<NonEmptyList<A>> = function (t1) {return function (f) {return f(___,[t1(f)])}}
...
export class Elem <A extends Q.ZM> implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["Elem",this._0.pretty(true)].join(' '))}
...
export class Cons <A extends Q.ZM> implements Q.ZM {
  ...
  pretty(nested=false):string {return Q.nestedPars(nested,["Cons",this._0.pretty(true),this._1.pretty(true)].join(' '))}
